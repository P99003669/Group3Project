...
public class Complaint implements Serializable {
	...
	public Complaint(int complaintId, String complaintType, LocalDate requestDate, String complaintDescription,
			int complaintIncharge, String complaintSubject, String requestStatus, String empId, String complaintRemark,
			int resolverid) {
		super();
		this.complaintId = complaintId;
		this.complaintType = complaintType;
