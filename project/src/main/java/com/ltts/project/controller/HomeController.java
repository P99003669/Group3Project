...
//						model.addAttribute("empId", e.getEmpId());
	...
	public List<Complaint> getExternalComp() {
		...
		ResponseEntity<Complaint[]> response = rt.getForEntity("http://localhost:8966/complaint/", Complaint[].class);
	...
	public List<Department> getExternalDept() {
		...
		ResponseEntity<Department[]> response = rt.getForEntity("http://localhost:8800/viewdepartments/",
				Department[].class);
